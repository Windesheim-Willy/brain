...
def HandleStateAutonomous():
	...
	if len(movebaseStatus.status_list) <= 0 or movebaseStatus.status_list[0].status == MoveBaseStatus.Succeeded or movebaseStatus.status_list[0].status == MoveBaseStatus.Aborted:
